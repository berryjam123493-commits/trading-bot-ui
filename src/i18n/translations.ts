...
export const translations = {
  ko: {
    ...
    chartPie: "파이",
    overlayLabel: "오버레이",
    overlayHint: "차트 위에 겹쳐 보이는 옵션들. 여러 개 동시 선택 가능.",
    timeUnitLabel: "시간 단위",
    timeUnitDay: "일",
    timeUnitWeek: "주",
    timeUnitMonth: "월",
    timeUnitYear: "년",
    overlayRegression: "회귀선",
    overlayRegressionFull: "데이터 점들로 만든 최소제곱 선형회귀선 (검정). 점(빨강)에 마우스/터치 시 이 선과의 거리를 표시합니다.",
    regressionLabel: "회귀선",
    deltaLabel: "Δ 회귀선",
    assetBreakdownTitle: "자산 구성",
    ...
    appSettings: "앱 설정",
    botControl: "봇 실행 제어",
    botControlDesc: "봇을 선택해서 일시정지/재개할 수 있습니다. '전체 봇 총 종합' 을 선택하면 모든 봇에 한번에 적용됩니다.",
    controlTarget: "제어 대상",
    allBotsAggregate: "전체 봇 총 종합",
    runningCount: "실행 중",
    pausedCount: "일시정지",
    pauseAction: "일시정지",
    resumeAction: "재개",
    statusRunning: "실행 중",
    statusPaused: "일시정지 상태",
    allBotsAlreadyPaused: "모든 봇이 이미 일시정지 상태입니다.",
    allBotsAlreadyRunning: "모든 봇이 이미 실행 중입니다.",
    noBotsToControl: "등록된 봇이 없습니다.",
    generalSettings: "일반",
  ...
  en: {
    ...
    overlayHint: "Overlays drawn on the chart. Multi-select.",
    timeUnitLabel: "Time unit",
    timeUnitDay: "Day",
    timeUnitWeek: "Week",
    timeUnitMonth: "Month",
    timeUnitYear: "Year",
    overlayRegression: "Regression",
    overlayRegressionFull: "Least-squares linear regression line (black). Hover/tap any red point to see its distance from the line.",
    regressionLabel: "Regression",
    deltaLabel: "Δ Regression",
    assetBreakdownTitle: "Asset Breakdown",
    ...
    botControl: "Bot Execution Control",
    botControlDesc:
      "Pick a bot to pause or resume. Choose 'All bots (aggregate)' to apply the action to every bot at once.",
    controlTarget: "Target",
    allBotsAggregate: "All bots (aggregate)",
    ...
    statusPaused: "Paused",
    allBotsAlreadyPaused: "All bots are already paused.",
    allBotsAlreadyRunning: "All bots are already running.",
    noBotsToControl: "No bots registered yet.",
