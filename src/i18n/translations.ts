...
export const translations = {
  ko: {
    ...
    chartPie: "파이",
    overlayLabel: "오버레이",
    overlayHint: "바 그래프 위에 겹쳐 보이는 옵션들. 여러 개 동시 선택 가능.",
    overlayLinear: "기준선",
    overlayLinearFull: "시작점 → 끝점 직선",
    overlayDistance: "편차 숫자",
    overlayDistanceFull: "각 지점과 기준선의 차이를 숫자로",
    deltaLabel: "Δ 기준선",
  ...
  en: {
    ...
    overlayHint: "Overlays drawn on top of the bar chart. Multi-select.",
    overlayLinear: "Linear",
    overlayLinearFull: "Straight line start → end",
    overlayDistance: "Δ Distance",
    overlayDistanceFull: "Show delta vs linear in tooltip",
    deltaLabel: "Δ Linear",
